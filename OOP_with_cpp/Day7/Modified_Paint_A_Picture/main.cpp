...
class GeoArt{
 ...
 public:
     ///Pure virtual function preferred using from programmers
     virtual void draw()=0;
};
class Point {
   private:
...
class Rectangle1:public GeoArt {
  Point Upper_left;
  Point Lower_right;
    public:
...
class Triangle1 :public GeoArt{
  ...
  Point Lower_Left;
    public:
      ...
      void draw(){
         line(Upper.getX(),Upper.getY(),Lower_Left.getX(),Lower_Left.getY());
         line(Upper.getX(),Upper.getY(),Lower_right.getX(),Lower_right.getY());
         line(Lower_Left.getX(),Lower_Left.getY(),Lower_right.getX(),Lower_right.getY());
      }
};
class Picture{
    Rectangle1 *Rct;
...
int main()
{
    ...
    Rectangle1 Rect(100,100,200,200);
    Draw(&Rect);
