...
/**
observation :
   that code provides error if you did not define private and public section
   data by default in class is Private


Hint :
   To Solve The Following Error Try To Erase Comments On Public And Private
**/
