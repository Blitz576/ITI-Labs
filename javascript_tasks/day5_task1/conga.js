            ...
            for (var n in e) {
              ...
              void 0 !== t &&
                ("number" == typeof r || "string" == typeof r
                  ? (t[n] = r)
                  : Array.isArray(r) && (t[n] = JSON.parse(JSON.stringify(r))));
            }
          }
          !(function () {
            var u,
              ...
              l =
                ...
                ("function" == typeof document.querySelector
                  ? document.querySelector("script[".concat(d, "]"))
                  : void 0),
              v = c(),
              p = [],
              ...
              if (f && m && m.token) {
                ...
                document.addEventListener("visibilitychange", function () {
                  if ("hidden" === document.visibilityState) {
                    if (L && A()) {
                      var t = e();
                      ((null == S ? void 0 : S.url) == t &&
                        (null == S ? void 0 : S.triggered)) ||
                        P(),
                        O(t);
                    }
                    !E && S && ((E = !0), R());
                ...
                var L = m && (void 0 === m.spa || !0 === m.spa),
                        ...
                        if (null == u) {
                          if ("function" == typeof f.getEntriesByType) {
                            ...
                            y &&
                              ...
                              y.length > 0 &&
                              ((g.timingsV2 = {}),
                              (g.versions.timings = 2),
                              delete g.timings,
                              n(y[0], g.timingsV2));
                          }
                          1 === g.versions.timings && n(s, g.timings),
                            n(d, g.memory);
                        } else k(g);
                        if (
                          ((g.firstPaint = M("first-paint")),
                          (g.firstContentfulPaint = M(
                            "first-contentful-paint"
                          )),
                          m &&
                            (m.icTag && (g.icTag = m.icTag),
                            N(g, m.abtestTags),
                            (g.siteToken = m.token)),
                          "function" == typeof f.getEntriesByType)
                        ) {
                          var h =
                              null !== (o = f.getEntriesByType("resource")) &&
                              void 0 !== o
                                ? o
                                : [],
                            T = 0,
                          ...
                          h.forEach(function (e) {
                            ...
                            g.tempResources &&
                              void 0 === g.tempResources[w] &&
                              (g.tempResources[w] = []);
                            var r = JSON.stringify(n).length;
                            T + r < 62e3 && g.tempResources
                              ? ((T += r), g.tempResources[w].push(n))
                              : (w++, (T = 0));
                          });
                        }
                        return (
                          JSON.stringify(g).length >= 64e3 &&
                            (g.resources = []),
                          void 0 !== u && (delete g.timings, delete g.memory),
                          g
                        );
                      })(r);
                    if (c && m) {
                  ...
                  R = function () {
                    var t = (function () {
                      ...
                      return (
                        m &&
                          (m.version && (r.versions.fl = m.version),
                          m.icTag && (r.icTag = m.icTag),
                          N(r, m.abtestTags),
                          (r.siteToken = m.token)),
                        b &&
                    ...
                    L || ((t.resources = []), delete t.tempResources),
                      m &&
                        (0, o.sendObjectBeacon)("", t, function () {}, !0, C);
                  },
                  B = function () {
                    var t =
                ...
                var A = function () {
                  ...
                  O = function (e) {
                    p.push({ id: v, url: e, ts: new Date().getTime() }),
                      p.length > 3 && p.shift();
                  };
                L &&
                  ((s = e()),
                  (function (t) {
                    ...
                    if (n) {
                      var r = function () {
                        (v = c()),
                          "function" == typeof f.clearResourceTimings &&
            ...
            function _(e) {
              ...
              switch (
                ("INP" !== e.name &&
                  (b[e.name.toLowerCase()] = { value: e.value, path: u }),
                e.name)
              ) {
                case "CLS":
                  (c = e.attribution) &&
                    b.cls &&
                    ((b.cls.element = c.largestShiftTarget),
                    (b.cls.currentRect =
                ...
                case "FID":
                  (c = e.attribution) &&
                    b.fid &&
                    ((b.fid.element = c.eventTarget),
                    (b.fid.name = c.eventType));
                  break;
                case "LCP":
                  (c = e.attribution) &&
                    b.lcp &&
                    ((b.lcp.element = c.element),
                    (b.lcp.size =
                      null === (r = c.lcpEntry) || void 0 === r
                        ? void 0
                        : r.size),
                    (b.lcp.url = c.url),
                    (b.lcp.rld = c.resourceLoadDelay),
                    (b.lcp.rlt = c.resourceLoadTime),
                    (b.lcp.erd = c.elementRenderDelay),
                    (b.lcp.it =
                  ...
                  break;
                case "INP":
                  (null == b.inp || Number(b.inp.value) < Number(e.value)) &&
                    ((b.inp = { value: Number(e.value), path: u }),
                    (c = e.attribution) &&
                      b.inp &&
                      ((b.inp.element = c.eventTarget),
                      (b.inp.name = c.eventType)));
              }
            }
            function x() {
              return f.timeOrigin;
              ...
              if ("function" == typeof f.getEntriesByType) {
                ...
                (e.timingsV2 = {}),
                  t &&
                    t[0] &&
                    t[0].nextHopProtocol &&
                    (r.nextHopProtocol = t[0].nextHopProtocol),
                  n(r, e.timingsV2);
              }
            }
            function M(e) {
              var t;
              if ("first-contentful-paint" === e && b.fcp && b.fcp.value)
                return b.fcp.value;
              if ("function" == typeof f.getEntriesByType) {
                var n =
                  null === (t = f.getEntriesByType("paint")) || void 0 === t
                    ? void 0
                    : t.filter(function (t) {
                        return t.name === e;
                      })[0];
                      ...
                      e.forEach(function (e) {
                        "first-contentful-paint" === e.name &&
                          ...
                          e.startTime < i.firstHiddenTime &&
                            ((o.value = Math.max(e.startTime - v(), 0)),
                            o.entries.push(e),
                            n(!0)));
                      });
                    });
            ...
            X = function (e, t) {
              ...
              Q(function () {
                ...
                if (o) {
                  ...
                  (r.value = Math.max(c - v(), 0)),
                    (r.entries = [o]),
                    i(!0),
                    l(function () {
                      (r = p("TTFB", 0)),
                        (i = g(e, r, n, t.reportAllChanges))(!0);
                    });
                }
              });
            };
                  ...
                  P(function () {
                    ...
                    var r,
                      ...
                      o = function (e) {
                        ...
                        var t,
                          n =
                            ((t = Math.min(J.length - 1, Math.floor(H() / 50))),
                            J[t]);
                        n &&
                          n.latency !== i.value &&
